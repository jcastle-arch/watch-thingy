...
The OEM (oem) stays at MSRP. Marketplace (c24) can swing slightly more.
If current is null, keep it null.

Return STRICT JSON only, no prose, no markdown fences:
{"quotes":[{"id":"oem","px":${watch.msrp}},{"id":"joma","px":6135},...all 7 retailers...],"note":"one short market note ≤14 words"}`;
